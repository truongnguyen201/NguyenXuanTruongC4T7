pokedex_list = {
    #Bulbasaur
    "BULBASAUR " : '''Bulbasaur can be seen napping in bright sunlight. 
There is a seed on its back. By soaking up the sun's rays,
the seed grows progressively larger.''',
    
    #Ivysaur
    "IVYSAUR" : '''There is a bud on this Pokémon's back. 
...
it's a sign that the bud will bloom into a large flower soon.''',
    ...
    #Venusaur
    "VENUSAUR" :'''There is a large flower on Venusaur's back. 
...
while loop:
    try:
        pokedex = input("eneter a pokedex name:")
        pokedex = pokedex.upper()
        print(pokedex_list[pokedex])
    except KeyError:
        pass